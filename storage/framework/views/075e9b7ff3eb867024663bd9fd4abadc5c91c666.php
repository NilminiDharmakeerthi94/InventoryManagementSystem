...
<div class="container">
  <div class="col-md-8">
    <div class="x_panel">
      ...
      <div class="x_content">
          <form action="<?php echo e(route('contacts.supply')); ?>" class="" method="post" enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>

                        <div class="form-group">
                        <label>Name Supplier</label>
                        <input type="" name="supplier_name" class="form-control" placeholder="Supplier Name.." value="<?php echo e(old('supplier_name')); ?>"/>  
                        </div>
                        <div class="form-group">
                        <label>Email</label>
                        <input type="text" name="email" class="form-control" placeholder="Emai.." value="<?php echo e(old('email')); ?>"/>  
                        </div>
